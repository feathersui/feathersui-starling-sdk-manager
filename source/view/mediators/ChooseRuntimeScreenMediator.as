...
package view.mediators
{
	...
	public class ChooseRuntimeScreenMediator extends Mediator
	{
		...
		override public function onRegister():void
		{
			...
			this.screen.runtimes = this.sdkManagerModel.runtimes;
			this.screen.selectedRuntime = this.sdkManagerModel.selectedRuntime;
			this.addViewListener(Event.COMPLETE, view_completeHandler);
		}
		
		private function view_completeHandler(event:Event):void
		{
			this.sdkManagerModel.selectedRuntime = this.screen.selectedRuntime;
		}
	}
}